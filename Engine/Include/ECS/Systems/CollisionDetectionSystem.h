...
//                     Math::Bounds2D transformedBoundsOther(transformOther->Position +
//                     collisionBoxOther->Bounds2D.Center,
...
//         void DrawDebugCollision(Umbra::Math::Bounds2D& transformedBounds, Umbra::Math::Bounds2D&
//         transformedBoundsOther,
...
//             sf::VertexArray* lines = new sf::VertexArray(sf::LinesStrip, 2);
//             (*lines)[0].position = sf::Vector2f((float) transformedBounds.Center.x, (float)
