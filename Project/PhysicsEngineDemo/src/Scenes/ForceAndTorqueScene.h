...
class ForceAndTorqueScene : public Umbra::Scene {
public:
...
private:
    ...
    float mParticleInertia             = 5.0f;
    float mParticleMass                = 1.0f;
    float mLinearForce                 = 20;
    float mImpulseForce                = 20;
    float mTorque                      = 2;
    float mAngularImpulse              = 2;
    Umbra::EntityID mCachedEntity      = Umbra::MAX_ENTITY;
    Umbra::Math::Vector2f mForceVector = Umbra::Math::Vector2f(0, 1);
};
