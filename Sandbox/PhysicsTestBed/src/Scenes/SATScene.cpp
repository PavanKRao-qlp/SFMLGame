...
void SATScene::OnFixedUpdate() {
    ...
    if (mShapeA == Box) {
        ...
        Umbra::RenderSystem::DrawDebugOrientedBox(boundsA, transformA->Angle, false, Umbra::Color::FromU8(60, 60, 60));
        ...
        for (int i = 0; i < pointsA.size(); i++) {
            Umbra::RenderSystem::DebugDrawLine(pointsA[(i + 1) % pointsA.size()], pointsA[i], Umbra::Color::FromU8(60, 60, 60));
        }
    }
    if (mShapeB == Box) {
        ...
        Umbra::RenderSystem::DrawDebugOrientedBox(boundsB, transformB->Angle, false, Umbra::Color::FromU8(60, 60, 60));
        ...
        for (int i = 0; i < pointsB.size(); i++) {
            Umbra::RenderSystem::DebugDrawLine(pointsB[(i + 1) % pointsB.size()], pointsB[i], Umbra::Color::FromU8(60, 60, 60));
        }
    }
    ...
    if (mShapeA != Circle && mShapeB != Circle) {
        ...
        if (bCollided) {
            ...
            for (auto point : collision.GetContacts()) {
                ...
                Umbra::RenderSystem::DebugDrawCircle(point.mContactPosition, 1.5, true, Umbra::Color::White);
                // }
            }
            if (bDrawContactPoint) {
                ...
                if (!mCollisionDetector->Clip(refEdge, clipped, refC1)) {
                    ...
                    Umbra::RenderSystem::DebugDrawCircle(clipped.first, 2.5, false, Umbra::Color::White);
                    Umbra::RenderSystem::DebugDrawCircle(clipped.second, 2.5, false, Umbra::Color::White);
                }

                Umbra::RenderSystem::DebugDrawCircle(verticesA[vaIx], 2.5, false, Umbra::Color::Red);
                Umbra::RenderSystem::DebugDrawCircle(verticesB[vbIx], 2.5, false, Umbra::Color::Green);
                Umbra::RenderSystem::DebugDrawCircle(vertexPrevA, 2.5, false, Umbra::Color::Blue);
                Umbra::RenderSystem::DebugDrawCircle(vertexNextA, 2.5, false, Umbra::Color::Yellow);
                Umbra::RenderSystem::DebugDrawCircle(vertexPrevB, 2.5, false, Umbra::Color::Blue);
                Umbra::RenderSystem::DebugDrawCircle(vertexNextB, 2.5, false, Umbra::Color::Yellow);
                Umbra::RenderSystem::DebugDrawLine(referenceEdge.first, referenceEdge.second, Umbra::Color::Red);
                Umbra::RenderSystem::DebugDrawLine(incidentEdge.first, incidentEdge.second, Umbra::Color::Green);
            }
    ...
    if (bShowProjections) {
        if (mShapeA != Circle) {
            ...
            for (auto normal : normals) {
                Umbra::RenderSystem::DebugDrawLine(Umbra::Math::Vector2f(0, 0), normal * 100, Umbra::Color::FromU8(0, 75, 75));
            }
        }
        if (mShapeB != Circle) {
            Umbra::Vector<Umbra::Math::Vector2f> normals = shapeB->GetNormals();
            for (auto normal : normals) {
                Umbra::RenderSystem::DebugDrawLine(Umbra::Math::Vector2f(0, 0), normal * 100, Umbra::Color::FromU8(75, 0, 75));
            }
        }
        ...
        for (Umbra::Math::Vector2f axis : normalsA) {
            ...
            // Umbra::RenderSystem::DebugDrawLine(axis * projectionB.Min, axis * projectionB.Max, Umbra::Color::Red);
            // Umbra::RenderSystem::DebugDrawLine(axis * projectionA.Min, axis * projectionA.Max, Umbra::Color::Blue);
    ...
    Umbra::RenderSystem::DebugDrawCircle(worldMousePos, 2.f, true, Umbra::Color::White);
    Umbra::RenderSystem::DebugDrawCircle(transformA->Position, 2.f, true, Umbra::Color::Cyan);
    ...
    Umbra::RenderSystem::DebugDrawCircle(transformB->Position, 2.f, true, Umbra::Color::Magenta);
...
Umbra::SharedPtr<Umbra::Scene> SATScene::InstantiateCopy() {
