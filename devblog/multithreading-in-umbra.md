# Multithreading in UMBRA Engine

*How we went from a single-threaded game loop to a full job system with dependencies and parallel work*
...
## M3 — `SubmitAfter`: Job Dependency Chains
...
## M4 — `ParallelFor`: Fork-Join Parallelism
